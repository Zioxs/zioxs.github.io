  ...
  en: [
    {
      ...
      description: 'From custom items to specific gameplay mechanics, I build exactly what you need in Forge or Fabric.',
      features: ['Forge & Fabric Support', 'Clean, documented code', 'Usage documentation provided'],
    },
    {
      icon: 'Box',
      title: 'Basic Model & Texture',
      description: 'I provide basic 3D modeling and custom texturing for your items, blocks, and entities using Blockbench.',
      features: ['Blockbench modeling', 'Custom texturing', 'Vanilla aesthetic matching'],
    },
    {
      icon: 'Package',
      title: 'Mod Tweaks & Configs',
      description: 'I can tweak, configure, and patch existing mods to fit your exact requirements.',
      features: ['Cross-mod patching', 'Config & balance tweaking', 'KubeJS & CraftTweaker'],
    },
  ] as Service[],
  id: [
    {
      ...
      description: 'Dari item kustom hingga mekanisme gameplay yang spesifik, saya membuat apa yang Anda butuhkan di Forge atau Fabric.',
      features: ['Mendukung Forge & Fabric', 'Kode bersih & terdokumentasi', 'Dokumentasi penggunaan disediakan'],
    },
    {
      icon: 'Box',
      ...
      features: ['Pemodelan Blockbench', 'Tekstur kustom', 'Sesuai estetika Vanilla'],
    },
    {
      icon: 'Package',
      title: 'Penyesuaian Mod & Konfigurasi',
      description: 'Saya dapat menyesuaikan, mengkonfigurasi, dan menambal mod yang ada agar sesuai dengan kebutuhan persis Anda.',
      features: ['Patching antar-mod', 'Penyesuaian config & keseimbangan', 'KubeJS & CraftTweaker'],
    },
  ] as Service[],
};
...
export const reviews = {
  en: [
    ...
    },
    {
      ...
      rating: 5,
      text: 'Have worked with him on various projects, his problem solving is fast and precise, with a deep understanding of Minecraft mods. Every result is always consistently outstanding.',
      projectsCount: 4,
    },
    {
      name: 'BlackBee',
  ...
  id: [
    ...
    },
    {
      ...
      avatarUrl: '/reviews/kaishi.png',
      rating: 5,
      text: 'Sudah bekerja sama dengannya di berbagai project problem solvingnya cepat dan presisi, dengan pemahaman mendalam tentang Minecraft mod. Setiap hasil selalu konsisten luar biasa.',
      projectsCount: 4,
    },
    {
      name: 'BlackBee',
