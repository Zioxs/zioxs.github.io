    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.inner}`}>
        <div className={styles.brand}>
          <Link href="/" className={styles.logo}>
            <span className={styles.logoIcon}>Zioxs</span>
          </Link>
        ...
        <nav className={styles.nav}>
          ...
          <Link href="/#contact" className={styles.link}>{t.nav.commission}</Link>
        </nav>

        <div className={styles.socials}>
          <a href={socials.email} className={styles.socialBtn} aria-label="Email">
            <Mail size={18} />
          </a>
          <a href={socials.modrinth} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="Modrinth">
            <svg width="18" height="18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <a href={socials.whatsapp} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="WhatsApp">
          ...
          <a href={socials.github} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div className={styles.bottom}>
        <div className="container">
          <p>© {new Date().getFullYear()} Zioxs. {t.footer.rights}</p>
        </div>
      </div>
    </footer>
  )
